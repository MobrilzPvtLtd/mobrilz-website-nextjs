import {
  ...
  import { FaCode, FaShoppingCart, FaMobile, FaServer, FaDatabase, FaDesktop } from 'react-icons/fa';
  ...
  const services = [
    {
      ...
      description: "Bespoke websites tailored to your specific business requirements",
      icon: FaCode,
    ...
    },
    {
      ...
      description: "Interactive web applications that solve complex business problems",
      icon: FaDesktop,
      ...
      <Breadcrumb mb={6} fontSize="sm">
        {items.map((item, index) => (
          <BreadcrumbItem key={index} isCurrentPage={item.isCurrentPage}>
            {item.isCurrentPage ? (
              <Text color="brand.500">{item.name}</Text>
            ) : (
              <NextLink href={item.path} passHref>
                <BreadcrumbLink title={item.title}>{item.name}</BreadcrumbLink>
              </NextLink>
            )}
          </BreadcrumbItem>
        ))}
              ...
              <Stack spacing={8}>
                <Stack spacing={4}>
                  <Heading 
                    ...
                    lineHeight="shorter"
                  >
                    Crafting High-Performance Branding Solutions
                  </Heading>
          ...
          <Container maxW="container.xl">
            <Stack spacing={12}>
              <Stack spacing={3} textAlign="center">
                ...
                “From custom web applications to e-commerce solutions, we’re here to support your business goals with comprehensive web development services.”
                </Text>
              </Stack>
